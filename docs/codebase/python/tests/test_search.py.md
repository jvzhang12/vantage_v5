...
- search and recalled payloads expose explicit product scope/provenance fields, including canonical records detected by root containment and experiment-scoped Memory Trace records,
