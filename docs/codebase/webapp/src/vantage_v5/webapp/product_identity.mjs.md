...
- Normalize first-pass learned correction copy so the UI can distinguish direct whiteboard/pin actions from non-direct wrong / temporary / forget requests without inventing unsupported backend mutations.
