...
- Foregrounding a Whiteboard open/draft clears the active operational surface id and visible-surface ids while preserving cached operational payloads, so hidden Today/calendar/task surfaces are not serialized as visible context on later turns.
