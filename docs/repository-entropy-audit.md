...
> Current source of truth: [README.md](../README.md), [docs/README.md](README.md), [architecture-overview.md](architecture-overview.md), [compatibility-ledger.md](compatibility-ledger.md), and [stale-artifact-inventory.md](stale-artifact-inventory.md)
